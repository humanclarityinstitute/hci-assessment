...
class SupabaseClient:
    ...
    def store_assessment(self, session_id: str, assessment_data: Dict[str, Any]) -> bool:
        """
        ...
        Args:
            ...
            assessment_data: Dictionary containing all assessment data (dimensions, scores, etc)
        ...
        try:
            ...
            body_dict = {
                ...
                **assessment_data  # Unpack all assessment data
            }
